function mapInterchange(textid)
{
    ...
    if(textid == "cracow")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek.png');
    ...
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/łokietomini.png');
    ...
    if(textid == "pgdik")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek2.png');
    ...
    if(textid == "pg2")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek3.png');
        h1.textContent = "Pomorze Gdańskie i Kujawy";
    ...
    if(textid == "mlb")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek4.png');
    ...
    if(textid == "nearmlp")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek5.png');
    ...
    if(textid == "brandem")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek6.png');
        h1.textContent = "Początkowe problemy";
        context.textContent = "Podczas pierwszych lat panowania Władysława Łokietka miało miejsce wiele trudności wewnętrznych. W Małopolsce dużą część opozycji stanowił biskup krakowski Jan Muskata. Problemem był też nowy król czeski – Jan Luksemburczyk, który był popierany przez mieszkańców Małopolski. W 1311 r wybuchł bunt mieszczan krakowskich pod wodzą wójta Alberta, na szczęście bunt został stłumiony przez Władysława Łokietka już rok później.";
    }
    if(textid == "nearcr")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek7.png');
    ...
    if(textid == "plock")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek8.png');
    ...
    if(textid == "nearcr2")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek9.png');
    ...
    if(textid == "nearcr3")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek16.png');
    ...
    if(textid == "nearmlp2")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek10.png');
    ...
    if(textid == "nearcr4")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek11.png');
        h1.textContent = "Łokietkowa ucieczka";
    ...
    if(textid == "kalisz")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek12.png');
    ...
    if(textid == "wlkp")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek13.png');
    ...
    if(textid == "czech")
    {
        image.setAttribute('src', '../../../RESOURCES/WLOKIETEK/SUBSITES/lokietek14.png');
